...
Die Übergangsfunktion $h(t)$, auch Sprungantwort, ist die Antwort im Zeitbereich auf die Heaviside-Funktion: \[\sigma (t) = \begin{cases} 0 & \text{für t < 0} \\ 1 & \text{für t > 0} \end{cases}\] \newline
